...
public partial class ComprasDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.HasKey(e => new { e.IdProducto, e.IdCompra }).HasName("pk_detalle_compra");

            entity.ToTable("detalle_compra", "finanzas");
            ...
            entity.HasOne(d => d.IdCompraNavigation).WithMany(p => p.DetalleCompras)
                ...
                .HasConstraintName("fk_detalle_compra_comp");
            ...
            entity.HasOne(d => d.IdProveedorNavigation).WithMany(p => p.DetalleCompras)
                ...
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("fk_detalle_compra_prov");
        });
        ...
        modelBuilder.Entity<DetalleOrdenesPago>(entity =>
        {
            ...
            entity.HasOne(d => d.IdCompraNavigation).WithMany(p => p.DetalleOrdenesPagos)
                .HasForeignKey(d => d.IdCompra)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("fk_detalles_ordenes_pago_comp");
        ...
        modelBuilder.Entity<Factura>(entity =>
        {
            ...
            entity.HasOne(d => d.IdCompraNavigation).WithMany(p => p.Facturas)
                .HasForeignKey(d => d.IdCompra)
                .OnDelete(DeleteBehavior.ClientSetNull)
        ...
        modelBuilder.Entity<MovimientosCc>(entity =>
        {
            ...
            entity.HasOne(d => d.IdCompraNavigation).WithMany(p => p.MovimientosCcs)
                .HasForeignKey(d => d.IdCompra)
                .HasConstraintName("fk_movimientos_cc_comp");
            ...
            entity.HasMany(d => d.IdCategoria).WithMany(p => p.IdProductos)
                .UsingEntity<Dictionary<string, object>>(
                    ...
                    j =>
                    {
                        ...
                        j.ToTable("productos_categorias", "logistica");
